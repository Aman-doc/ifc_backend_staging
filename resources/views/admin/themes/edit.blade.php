...
<div class="max-w-5xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
    <div class="flex justify-between items-center pb-5 border-b border-gray-100">
        <div>
            <h1 class="text-xl font-bold text-gray-800">Edit Theme</h1>
            <p class="text-xs text-gray-500 mt-0.5">Update selected Data Sources and Indicators</p>
        </div>
    ...
    <form action="{{ route('admin.themes.update', $theme->id) }}" method="POST" class="mt-6">
        @csrf
        @method('PUT')
        ...
        <div class="mb-5">
            ...
            <input type="text" name="name" id="theme_name" value="{{ old('name', $theme->name) }}" required placeholder="e.g. Climate Action, Forest Cover" 
